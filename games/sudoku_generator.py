...
def board_creator(N=9,K=35):
    sudoku_solved = Sudoku(N, K)
    sudoku_solved.fillValues()
    sudoku_empty = deepcopy(sudoku_solved)
    sudoku_empty.removeKDigits()
    return (sudoku_empty, sudoku_solved)